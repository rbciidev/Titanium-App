function DashboardUI(parent){
	...
	var soaimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/my account.png',
		width: isize,
		height:iheight
	});
	soaview.add(soaimg);
	...
	var trnimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/transaction history.png',
		width: isize,
		height:iheight
	});
	trnview.add(trnimg);
	...
	var encimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/encashment history.png',
		width:isize,
		height:iheight
	});
	encview.add(encimg);
	...
	var strimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/instore purchase.png',
		width:isize,
		height:iheight
	});
	strview.add(strimg);
	...
	var gcimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/distributors.png',
		width:isize,
		height:iheight
	});
	gcview.add(gcimg);
	...
	var binimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/sales network.png',
		width: isize,
		height:iheight
	});
	binview.add(binimg);
	...
	var mlmimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/multi level.png',
		width: isize,
		height:iheight
	});
	mlmview.add(mlmimg);
	...
	var uniimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/unilevel.png',
		width:isize,
		height:iheight
	});
	uniview.add(uniimg);
	...
	var conimg = Titanium.UI.createImageView({
		image:'/images/dashboard/small/conference.png',
		width:isize,
		height:iheight
	});
	conview.add(conimg);
