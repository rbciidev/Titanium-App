...
function Transactions(){
	...
	function createRow(items){
		...
		var tdaterow = createRowView('Trans Date', items.TDate, 'right');
		tdaterow.top = '2%';
		container.add(tdaterow);
		container.add(createRowView('Remarks', items.Remarks, 'right'));
		container.add(createRowView('Debit', items.Debit == '0.00' ? '' : items.Debit, 'right'));
		container.add(createRowView('Credit', items.Credit == '0.00' ? '' : items.Credit, 'right'));
		container.add(createRowView('Balance', items.Balance, 'right'));
	...
	function reloadData(pageno, isscroll){
		...
		var url = urlroot+'GetTransactions';
		var data;
